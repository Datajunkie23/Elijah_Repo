...
To download any file from this project, open the file you want to download, click the **three-dot menu (`⋯`)** in the top-right corner, and select **Download**.

> This allows you to download and explore the SQL script, dataset, and other available project files directly on your device.
